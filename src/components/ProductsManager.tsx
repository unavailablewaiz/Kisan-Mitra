...
const ProductsManager: React.FC<ProductsManagerProps> = ({
  ...
  const fetchMyProducts = async () => {
    ...
    try {
      const response = await fetch(
        ...
        "https://kisan-india-backend.vercel.app/api/products/products"
      );
  ...
  const deleteProduct = async (productId: string, productName: string) => {
    if (
      ...
      try {
        const response = await fetch(
          `https://kisan-india-backend.vercel.app/api/products/products/${productId}`,
          {
            method: "DELETE",
          }
        );
  ...
  const handleEditSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        `https://kisan-india-backend.vercel.app/api/products/products/${editingProduct._id}`,
        {
          method: "PUT",
          headers: {
